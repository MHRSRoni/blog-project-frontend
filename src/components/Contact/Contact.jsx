    ...
    return (
        <div className="border-personal">
            ...
            <div className="flex items-center pt-3">
                ...
                <span className="mx-1 text-black">    Health Plus        </span>
                <div className="flex-1 border-t border-black my-4"></div>
            </div>
            ...
            <p className='text-[13px] mt-6 mb-3 pb-3 text-center'>For any Kind of products Contact Our Social Media Platforms</p>
