...
const Contact = () => {
  return (
    <div className="border-personal">
      ...
      <div className="flex items-center justify-center">
        <div className="text-center my-6">
          <img
            ...
            alt="Health Plus"
            className="max-w-[80px] round- h-auto"
          />
        </div>
      </div>

      <h1 className="text-center text-xs font-semibold uppercase">
        Authenticate Product
      </h1>
      <h1 className="text-center text-[10px] font-semibold uppercase">
        At best price
      </h1>
      ...
      <p className="text-[13px] mt-6 mb-3 pb-3 text-center">
        For any Kind of products Contact Our Social Media Platforms
      </p>
    </div>
  );
};
