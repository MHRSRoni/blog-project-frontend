...
const RelatedPosts = ({ categoryId, postId }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (Array.isArray(relatedPosts)) {
        const filteredPosts = relatedPosts.filter((post) => post._id !== postId);
        ...
        console.error("Latest posts data is not an array:", relatedPosts);
      }
    } catch (error) {
